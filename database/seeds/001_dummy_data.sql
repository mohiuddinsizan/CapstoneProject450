...
INSERT INTO locations (id, name, building, floor)
VALUES
  ('22222222-2222-2222-2222-222222222223', 'Central Library', 'Library Block', '1'),
  ('22222222-2222-2222-2222-222222222224', 'Engineering Building', 'Block C', '3'),
  ('22222222-2222-2222-2222-222222222225', 'Business School', 'Block D', '2'),
  ('22222222-2222-2222-2222-222222222226', 'Student Center', 'Main Hall', 'Ground')
ON CONFLICT (id) DO NOTHING;

-- ADD MORE LOCKERS
INSERT INTO lockers (id, location_id, locker_name, series, status, public_key, firmware_version, created_at)
VALUES
  ('33333333-3333-3333-3333-333333333333', '22222222-2222-2222-2222-222222222223', 'L-102', 'S1', 'AVAILABLE', 'pubkey-102', '1.0.0', NOW()),
  ('33333333-3333-3333-3333-333333333334', '22222222-2222-2222-2222-222222222223', 'L-103', 'S1', 'AVAILABLE', 'pubkey-103', '1.0.0', NOW()),
  ('33333333-3333-3333-3333-333333333335', '22222222-2222-2222-2222-222222222224', 'L-301', 'S2', 'AVAILABLE', 'pubkey-301', '1.0.2', NOW()),
  ('33333333-3333-3333-3333-333333333336', '22222222-2222-2222-2222-222222222224', 'L-302', 'S2', 'MAINTENANCE', 'pubkey-302', '1.0.2', NOW()),
  ('33333333-3333-3333-3333-333333333337', '22222222-2222-2222-2222-222222222225', 'L-401', 'S3', 'AVAILABLE', 'pubkey-401', '1.1.0', NOW()),
  ('33333333-3333-3333-3333-333333333338', '22222222-2222-2222-2222-222222222225', 'L-402', 'S3', 'OCCUPIED', 'pubkey-402', '1.1.0', NOW()),
  ('33333333-3333-3333-3333-333333333339', '22222222-2222-2222-2222-222222222226', 'L-001', 'S1', 'AVAILABLE', 'pubkey-001', '1.0.5', NOW()),
  ('33333333-3333-3333-3333-333333333340', '22222222-2222-2222-2222-222222222226', 'L-002', 'S1', 'AVAILABLE', 'pubkey-002', '1.0.5', NOW())
ON CONFLICT (id) DO NOTHING;

-- ADD ACTIVE BOOKINGS (THIS IS IMPORTANT FOR LOCKER DEVICE)
INSERT INTO bookings (id, user_id, locker_id, plan_id, total_amount, status, start_at, end_at, created_at)
VALUES
  (
...
-- ADD ACCESS GRANT (THIS MAKES LOCKER "UNLOCKABLE")
INSERT INTO access_grants (id, booking_id, user_id, locker_id, status, start_at, end_at)
VALUES
  (
